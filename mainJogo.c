...
int main(){
    ...
    do{
		...
		// repete até alguém ganhar ou atingir 9 jogadas
        // imprimir o jogo
        // t de tabulacao para separar o jogo da margem esquerda
        do{
            printf("\n\n\t 0   1   2\n\n");
            for(l = 0; l < 3; l++){
                for(c = 0; c < 3; c++){
            ...
            // quem ganhou na diagonal principal
            ...
            // quem ganhou na diagonal secundária
